...
class __TwigTemplate_6fa00aa4351377062135a46a4267964a extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<td>{{ value.phone }}</td>
\t\t\t<td>
\t\t\t\t<a href='edit_user/{{value.id}}'>Edit</a>
\t\t\t</td>
\t\t\t<td>
\t\t\t\t<a href='delete_user/{{value.id}}'>Delete</a>
\t\t\t</td>
\t\t</tr>
\t{% endfor %}
</table>
", "modules/dependency_injection_services/templates/my-template.html.twig", "/var/www/web/modules/dependency_injection_services/templates/my-template.html.twig");
    }
