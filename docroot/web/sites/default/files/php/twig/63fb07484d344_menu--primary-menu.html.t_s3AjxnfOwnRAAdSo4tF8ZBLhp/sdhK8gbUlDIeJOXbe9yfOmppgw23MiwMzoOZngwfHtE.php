...
class __TwigTemplate_b05d6cd1000f7eeec8e170c4924a11ba extends Template
{
    private $source;
    private $macros = [];
...
{% macro menu_links(items, attributes, menu_level, aria_id) %}
  ...
  {% endif %}
{% endmacro %}
", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "/var/www/web/core/themes/olivero/templates/navigation/menu--primary-menu.html.twig");
    }
